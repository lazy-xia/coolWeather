...
import pro.android2.coolweather.gson.Forecast;
import pro.android2.coolweather.gson.Weather;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        weatherInfoText = (TextView) findViewById(R.id.wearher_info_text);
                    ...
                    public void run() {
                        if (weather == null) {
                            ...
                            if ("ok".equals(weather.status)) {
                                SharedPreferences.Editor editor = (SharedPreferences.Editor) PreferenceManager.getDefaultSharedPreferences(WeatherActivity.this).edit();
    ...
    private void loadBingPic() {
        ...
        HttpUtil.sendOkHttpRequest(requestBingPic, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                Log.i(TAG, "responseText:" + bingPic);
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        for (Forecast forecast : weather.forecastList) {
            ...
            TextView minText = (TextView) view.findViewById(R.id.min_text_text);
